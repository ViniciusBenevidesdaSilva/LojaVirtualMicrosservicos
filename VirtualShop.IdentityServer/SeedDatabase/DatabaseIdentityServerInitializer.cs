...
public class DatabaseIdentityServerInitializer : IDatabaseSeedInitializer
{
    ...
    public void InitializeiSeedRoles()
    {
    ...
    private void InitializeSeedAdmin()
    {
        ...
        IdentityResult resultAdmin = _userManager.CreateAsync(admin, "Admin1@").Result;
    ...
    private void InitializeSeedUser()
    {
        ...
        IdentityResult resultClient = _userManager.CreateAsync(client, "Client1@").Result;
